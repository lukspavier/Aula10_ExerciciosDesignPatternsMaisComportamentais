...
public class Teste {
	...
	public static void main(String[] args) {
		...
		String item = JOptionPane.showInputDialog(
				"Escolha o item: (1) Rosquinha - R$2,00; (2) Chocolate - R$4,50; (3) Pirulito - R$0,75");
		switch (item) {
		case "1":
			preco = 2.00;
			break;
		...
		if (preco > 0) {
			while (preco > inserido) {
				...
				double nova = slot5.recebeMoeda(
						Integer.parseInt(JOptionPane.showInputDialog("Insira uma moeda (5, 10, 25, 50, 100)")));
				inserido += nova;
			}
